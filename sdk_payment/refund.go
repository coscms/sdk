...
type RefundOptions struct {
	...
	OrderNo    string `json:"orderNo" xml:"orderNo" form:"orderNo"`                                               // 平台订单号
	OutOrderNo string `json:"outOrderNo" xml:"outOrderNo" form:"outOrderNo" valid:"required" validate:"required"` // 你的订单号

	// - 退款信息 -

	RefundAmount float64 `json:"refundAmount" xml:"refundAmount" form:"refundAmount" valid:"required;min(0.01)" validate:"required"` // 退款金额
	OutRefundNo  string  `json:"outRefundNo" xml:"outRefundNo" form:"outRefundNo"`                                                   // 你的退款单号
	RefundReason string  `json:"refundReason" xml:"refundReason" form:"refundReason"`                                                // 退款原因
	NotifyURL    string  `json:"notifyURL" xml:"notifyURL" form:"notifyURL"`                                                         // 通知接口网址

	AlwaysSave *bool `json:"alwaysSave,omitempty" xml:"alwaysSave,omitempty" form:"alwaysSave"` // 是否在支付网关不支持退款时依然保存退款单
